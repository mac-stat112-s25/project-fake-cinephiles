...
Letterboxd is an app popularized in recent years, made solely for logging movie watches and reviews.
...
Using a geom_smooth, it's clear to see the relationship is linear to a pretty mild extent, with Letterboxd ratings usually being more stagnant than IMDb ones for the movies we observed.
...
Letterboxd users, for specific movies, seem to be tougher critics, but given the popularity of the website and how many not-super-serious users rate movies, the results mostly align with IMDb opinions.
...
This left less than 250 movies for a detailed analysis.
